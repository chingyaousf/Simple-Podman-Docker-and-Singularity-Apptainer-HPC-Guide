...
or use it in HPC, following the demonstration in HPC.
...
80027256\@red2 podman_example]\$ mof-docker-upload localhost/sample_app
...
To **run docker image** sample_app please execute the first command

below on a login node and the second one inside a Slurm batch script on any node.

apptainer pull \--no-https [docker://localhost:5000/nemp-students-and-trainees/sample_app](docker://localhost:5000/nemp-students-and-trainees/sample_app)
...
80027256\@red2 podman_example]\$ apptainer pull \--no-https [docker://localhost:5000/nemp-students-and-trainees/sample_app](docker://localhost:5000/nemp-students-and-trainees/sample_app)
